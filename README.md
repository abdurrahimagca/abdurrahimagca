...
{
  {
    "title": "<strong>Hi!</strong> I'm Abdurrahim <i>Alpha Bravo Delta Uniform Romeo Romeo Alpha Hotel India Mike</i>"
  },
  {
    "subtitle_section": {
      "data": [
        {
          "subtitle": "I'm currently freelancing in <strong>Web and Mobile Development</strong>.",
          "tech_stack": [8 items]
        }
      ]
    }
...
```json
{
      ...
      "e-mail": "agcaabdurrahim@outlook.com" 
}
```
